...
\item
	...
	\begin{itemize}
		\resitem{ApplyBoard is an online application platform for students anywhere in the world to find the best university or college in Canada or U.S and apply to it. \url{https://www.applyboard.com} }
...
\item
	...
	\end{itemize}
\item
	\ressubheading{JPEG Image Decoder}{}{Individual hobby project written in C and Matlab}{Jan. 2015 - Jun. 2015}
	\begin{itemize}
