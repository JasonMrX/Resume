...
\item{\textbf {Web Development:}} Proficient in web development with \textbf{Ruby on Rails}, HTML, CSS and Javascript; Also experienced in JSP, JDBC and Flex. Hands-on experience in more than \textbf{3 real-world projects}
